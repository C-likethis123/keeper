...
6. Separate test files from implementation files in Rust.
7. In desktop it scrolls up after saving.
8. Looks so weird on desktop. I think I'll seriously consider the react native approach and see if it simplifies things for me....

...
- **Phase 9**: Collapsible blocks in progress; `<details>` trigger conversion and toolbar insertion are implemented with unit tests; next is device validation and polish

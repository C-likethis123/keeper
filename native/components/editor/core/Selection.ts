...
export function getSelectionStart(selection: DocumentSelection): DocumentPosition {
...
export function getSelectionEnd(selection: DocumentSelection): DocumentPosition {
...
export function collapseSelection(
  ...
  const position = toStart ? getSelectionStart(selection) : getSelectionEnd(selection);

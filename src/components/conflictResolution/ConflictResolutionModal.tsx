import ConflictComparisonView from "@/components/conflictResolution/ConflictComparisonView";
...
export default function ConflictResolutionModal({
  ...
  const handleResolve = async (
    ...
    try {
      ...
      if (Platform.OS === "web") {
        window.alert(
          `Resolution Failed: Could not resolve conflict: ${message}`,
        );
      } else {
        Alert.alert(
          "Resolution Failed",

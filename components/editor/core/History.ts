...
import { Transaction, isTransactionEmpty, applyTransaction, createInverseTransaction } from './Transaction';
...
export class History {
  ...
  push(transaction: Transaction, document: Document): void {
    ...
    if (
      ...
      now.getTime() - this.lastTransactionTime.getTime() < this.config.groupingDelay
    ) {
